...
public class PreferencesActivity extends PreferenceActivity implements
    ...
    public static String KEY_BUTTON_DRIVING_MODE="button_driving_mode";
...
//        });
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        else if (key.equals(KEY_BUTTON_DRIVING_MODE)){
            enableDrivingMode();
        }
    }

    private void enableDrivingMode() {
        ListPreference lp = (ListPreference) findPreference(KEY_BUTTON_DRIVING_MODE);
